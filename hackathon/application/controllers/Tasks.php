...
class Tasks extends CI_Controller
{
    ...
    public function index() {
        ...
        $tasks = $this->TasksModel->get_tasks($this->session->userdata['user_id']);
    ...
    public function add_task() {
        ...
        if($return_array = $this->TasksModel->add_task($this->session->userdata['user_id'], $this->input->post('task'))) {
