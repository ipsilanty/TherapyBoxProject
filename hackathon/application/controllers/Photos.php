...
class Photos extends CI_Controller
{
    ...
    public function index() {
        ...
        //Get all photos
        $photos = $this->PhotosModel->get_photos($this->session->userdata['user_id']);
    ...
    public function photo_upload() {
        ...
        if (!$this->upload->do_upload($file_element_name)) {
            ...
            $return_array = $this->PhotosModel->add_photo($this->session->userdata['user_id'], $image_data['file_name']);
            $data = array(
                'status' => "success",
